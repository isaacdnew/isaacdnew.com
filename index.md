      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3">
        ...
        <div class="card">
          ...
          <div class="card-footer">
            <a href="projects/ice-keys" class="btn btn-secondary btn-sm btn-block">See project</a>
          </div>
        </div>
        <!-- 3lb 2020 -->
        <div class="card">
          ...
          <div class="card-footer">
            <a href="projects/crc/3lb-2020" class="btn btn-secondary btn-sm btn-block">See project</a>
          </div>
        </div>
        <!-- Reuleaux L6 -->
        <div class="card">
          ...
          <div class="card-footer">
            <a href="projects/classes/reuleaux-l6" class="btn btn-secondary btn-sm btn-block">See project</a>
          </div>
        </div>
        <!-- Frog -->
        <div class="card">
          ...
          <div class="card-footer">
            <a href="projects/frog" class="btn btn-secondary btn-sm btn-block">See project</a>
          </div>
        </div>
      </div>
    </div>
